    ...
    <input type="hidden" name="id" id="id" value="<?= $Buku['id']; ?>">
        <ul style="list-style: none;">
            <li>
                ...
                : <input type="file" class="custom-file-input" id="image" name="image" require value="<?= $Buku['img']; ?>"><br><br>
            </li>
            <li>
                <label for="nama" style="margin-right: 16px;">Nama</label>
                : <input type="text" name="nama" id="nama" require value="<?= $Buku['img']; ?>"><br><br>
            </li>
            <li>
                <label for="Deskripsi" style="margin-right: 21px;">Deskripsi</label>
                : <input type="text" name="Deskripsi" id="Deskripsi" require value="<?= $Buku['img']; ?>"><br><br>
            </li>
            <li>
            <label for="Tipe">Tipe</label>
                :   <select name="Tipe" id="Tipe" require value="<?= $Buku['img']; ?>">
            ...
            <li>
                ...
                : <input type="text" name="harga" id="harga" require value="<?= $Buku['img']; ?>"><br><br>
            </li>
